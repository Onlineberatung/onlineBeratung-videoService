...
import de.caritas.cob.videoservice.api.helper.json.OffsetDateTimeToStringSerializer;
...
public class JsonHelper {
  ...
  /**
   * Serialize a object with specific serializer for {@link OffsetDateTime}.
   *
